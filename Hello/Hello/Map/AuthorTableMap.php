...
use Hello\Hello\Author;
use Hello\Hello\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Hello.Hello.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\Hello\\Hello\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Hello.Hello.Author';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(AuthorTableMap::COL_ID, AuthorTableMap::COL_FIRSTNAME, AuthorTableMap::COL_LASTNAME, ),
        self::TYPE_FIELDNAME     => array('Id', 'FirstName', 'LastName', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(AuthorTableMap::COL_ID => 0, AuthorTableMap::COL_FIRSTNAME => 1, AuthorTableMap::COL_LASTNAME => 2, ),
        self::TYPE_FIELDNAME     => array('Id' => 0, 'FirstName' => 1, 'LastName' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Hello\\Hello\\Author');
        ...
        $this->addColumn('LastName', 'Lastname', 'VARCHAR', true, 200, null);
    } // initialize()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Hello\Hello\Author) { // it's a model object
