...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Hello\\Hello\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of Hello\Hello\Base\Author object.
     */
     ...
     * @return $this|\Hello\Hello\Author The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Hello\\Hello\\Author'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Hello\Hello\Author
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Hello\Hello\Author The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Hello\Hello\Author (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Hello\Hello\Author Clone of current object.
     * @throws PropelException
     */
